...
public class Run {
	public static void main(String[] args) {
		...
		*/
		...
		Desktop d = new Desktop("삼성", "d-01", "짱짱", 10000,true);
		SmartPhone s = new SmartPhone("애플", "s-01", "아이폰", 130000, "SK");
		Tv t = new Tv("엘지", "t-01", "겁나얇은티비", 3500000, 58);
		 ...
		 * - 공통적인 코드들을 하나의 클래스로 관리하기 때문에 새로운 코드를 추가하거나 변경에 용이 하다. 
		 * 	=> 유지보수에 좋다! 생산성 향상
		 * 
		 * * 상속의 특징
		 * - 클래스간의 상속은 다중 상속 불가능!!(단일 상속만 가능 즉, 부모는 하나여야됨!!) 
		 * - 모든 클래스들은 명시되어 있진 않지만 Object 클래스의 후손이다. 
		 * 	 => 즉, object 클래스가 제공하는 메속드들을 오버라이딩해서 재정의 할 수 있다
		 * 
		 * 
		 */
