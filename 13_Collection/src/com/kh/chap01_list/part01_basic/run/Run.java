...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * >프래임워크 : 데이터나 기능들을 다루기 쉽게 이미 정의되어있는 틀
		 * 
		...
		// * ArrayList
		ArrayList<Music> list = new ArrayList</*Music*/>(3);	// 크기 지정할 수도 있긴함 !! (안해도됨! 안하면 기본사이즈 10인 배열)  
...
//		Music m = (Music)list.get(0); --> 제네릭스 적용 전 --> 강제형변환 해야만 함 (왜? Object로 반환하기 때문)
		Music m = list.get(0); // 어딘가에 기록해둘수 있다. 
		System.out.println(m);
		System.out.println(m.getTitle());
		
		// 7. subList(int index, int index2) : List lit
	//    첫번쨰 인덱스 ~ 두번쨰 인덱스까지 추출해서 새로운 List로 반환해주는 메소드 
...
//		list.clear(); 
		 ...
		 *  2. 저장된 객체를 꺼내서 사용할 떄 매번 형변환하는 절차를 없애기 위해
		 *  
		 */
