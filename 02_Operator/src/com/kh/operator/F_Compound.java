...
public class F_Compound {
	...
	public void method1() {		// start method1
		...
		// num을 3 증가시키기 // 오리지날 방법 보다 조금 더 빠르게 실행 할 수 있어서 활용하면 좋다. 
		num += 3;		
		System.out.println(" 3증가시킨 값 : " + num);  //18
		
		// num을 5 감소
		num -= 5;
		System.out.println("5감소시킨 값 : " + num); // 13
		...
		// num을 4로 나눴을때의 나머지 값으로 바꾸기
		num %=4;
		System.out.println("4나누기 나머지 값 : " + num); // 3
