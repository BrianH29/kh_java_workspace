...
public class B_InDecrease {
	 ...
	 *  	-- : 해당 변수에 담긴 값을 1 감소시키는 연산자
	 *  
	 *  	(증감연산자)변수 : 전위 연산자 			=> 선증감 후처리  
	 *  	변수(증감연산자) : 후의 연산자			=> 선처리 후증감 
	 *   
	 */
	...
	public void method1() { 		// start method1
		...
		System.out.println("기존 num1 : " + num1);			// num1 = 10
		System.out.println("전위증가 1회 수행 결과 : " + ++num1);		// num1 = 11로 증가된 후 출력
		System.out.println(" 전위증가 2회 수행 결과 : " + ++num1);	// num1 = 12로 증가된 후 출력
		System.out.println("전위증가 3회 수행 결과 :  " + ++num1);	// num1 = 13로 증가된 후 출력
		...
		System.out.println("기존 num2 : " + num2);							// num2 = 10 출력
		System.out.println("후위 증가 1회 수행 결과 : " + num2++);	// 기존 10 출력 후 num2=11 
		System.out.println("후위 증가 2회 수행 결과 : " + num2++);	// 기존 11 출력 후 num2 = 12
		System.out.println("후위 증가 3회 수행 결과 :  " + num2++);	// 기존 12 출력 후 num2 = 13
