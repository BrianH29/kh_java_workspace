...
public class G_Triple {
	 ...
	 *  [표현법] 	<값	?	값	: 값>   조건식 ? 조건식이 true일 경우 값 : 조건식이 false일 경우 값;
	 *  
	 *  조건식에는 반드시 true or false가 나오게끔 작성해야됨
	 *  주로 비교연산 / 논리연산 사용 
	 *  
	 */
	...
	public void method3() { // start method3
		...
		//String result = multi  >= 100 ? "100 이상입니다. " : "100보다 작습니다.";
		
		String result = multi  <= 100 ? "100 보다 작습니다. " : "100이상 입니다.";
		
		System.out.println(multi + "은 " + result);
	...
	public void method4() {	// start method4
		...
		// 비교 대상은 항상 왼쪽에 두는게 다른 사람이 나중에 코딩 봤을때 좋음. (권장) 
	...
	public void method6() { // start method6
		...
		char op  = sc.next().charAt(0);
		 ...
		 //String result = (op == '+' && op == '-' ) ? (num1+num2+" ") : (num1 - num2 + " ") ? ( op != '+' && op!= '-') : "잘못 입력하였습니다.";
		
		String result = (op == '+') ? (num1+num2 + " ") : 
			((op == '-') ? (num1 - num2 + " ") : ("잘못 입력하였습니다."));  
		
		// 숫자 값을 int를 글자 string으로 빼려면 끝에 빈 칸 " " 하나 만들어주면 int ->String으로 출력 
