...
public class ObjectArrayTest {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(books[0].getPrice(0));
		*/
		
		
		Book[] books = new Book[3];  // == Book bk1 = null; Book bk2 = null; Book bk3 = null;
...
//		System.out.println(books[2].information());
		...
		int count = 0; 	// 검색된 도서 수를 담아줄 변수 --> else 검색되는 도서가 없습니다를 실행 하기 위해 
		for(int i=0;i<books.length;i++) {
