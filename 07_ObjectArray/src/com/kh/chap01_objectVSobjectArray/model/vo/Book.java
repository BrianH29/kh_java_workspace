...
public class Book {
	...
	//접근제한자 클래스명(매개변수, 매개변수......) { } - 매개변수 생성자: 새성뿐만 아니라 전달값들을 필드에 초기화까지 
	...
	// setter 메소드 : 전달 값 받은 후 해당 필드에 초기화할 목적 
	...
	// information 메소드 : 모든 필드에 담긴 값들을 하나의 문자열로 합쳐서 반환할 목적 
	
	public String information() {
		return "재목 : " + title + " 저자: " + author + " 가격: " + price + " 출판사: " + publisher; 
